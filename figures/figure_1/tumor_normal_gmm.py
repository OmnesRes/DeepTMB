...
plt.savefig(cwd / 'figures' / 'figure_1' / 'results' / 'normal_gmm_input_output.png', dpi=600)
...
plt.savefig(cwd / 'figures' / 'figure_1' / 'results' / 'normal_gmm_distributions.png', dpi=600)
...
ax.set_ylim(-2, 2)
ax.set_xlim(-.01, t.trf(60))
plt.savefig(cwd / 'figures' / 'figure_1' / 'results' / 'normal_gmm_residuals.png', dpi=600)
