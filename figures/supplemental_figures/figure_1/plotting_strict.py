...
x_pred, preds = pickle.load(open(cwd / 'figures' / 'figure_2' / 'results' / 'strict_preds.pkl', 'rb'))
...
ax.vlines(t.trf(26), -.3, t.trf(40), linestyles='dotted', colors='k', alpha=.3)
...
plt.savefig(cwd / 'figures' / 'supplemental_figures' / 'figure_1' / 'results' / 'ancestry_strict.pdf')