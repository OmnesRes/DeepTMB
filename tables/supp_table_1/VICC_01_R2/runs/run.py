...
X = np.array([i / (panels.loc[panels['Panel'] == 'VICC-01-R2']['total'].values[0] / 1e6) for i in samples['panel_counts'].values])
...
with open(cwd / 'tables' / 'supp_table_1' / 'VICC_01_R2' / 'results' / 'run_predictions.pkl', 'wb') as f:
