...
run_predictions, values, losses = pickle.load(open(cwd / 'tables' / 'supp_table_6' / 'tumor_only_strict' / 'results' / 'without_ancestry.pkl', 'rb'))
...
print('with ancestry')
run_predictions, values, losses = pickle.load(open(cwd / 'tables' / 'supp_table_8' / 'tumor_only_strict' / 'results' / 'with_ancestry.pkl', 'rb'))
