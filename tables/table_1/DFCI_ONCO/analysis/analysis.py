...
print('deeptmb')
run_predictions, test_idx, values = pickle.load(open(cwd / 'tables' / 'table_1' / 'DFCI_ONCO' / 'results' / 'run_nonsyn_predictions.pkl', 'rb'))
...
print('hotspots')
run_cancer_predictions, test_idx, values = pickle.load(open(cwd / 'tables' / 'table_1' / 'DFCI_ONCO' / 'results' / 'run_hotspots_predictions.pkl', 'rb'))
...
print('syn')
run_predictions, test_idx, values = pickle.load(open(cwd / 'tables' / 'table_1' / 'DFCI_ONCO' / 'results' / 'run_predictions.pkl', 'rb'))
...
print('hotspots syn')
run_cancer_predictions, test_idx, values = pickle.load(open(cwd / 'tables' / 'table_1' / 'DFCI_ONCO' / 'results' / 'run_hotspots_syn_predictions.pkl', 'rb'))
...
print('nci')
run_cancer_predictions, test_idx, values = pickle.load(open(cwd / 'tables' / 'table_1' / 'DFCI_ONCO' / 'results' / 'run_nci_predictions.pkl', 'rb'))
