...
panel_pr = pr.PyRanges(genie.loc[genie['SEQ_ASSAY_ID'] == 'DFCI-ONCOPANEL-3'][['Chromosome', 'Start_Position', 'End_Position']].rename(columns={'Start_Position': 'Start', 'End_Position': 'End'}))
...
with open(cwd / 'tables' / 'table_1' / 'DFCI_ONCO' / 'data' / 'data.pkl', 'wb') as f:
    pickle.dump(data, f)
