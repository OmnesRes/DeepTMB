...
anc = np.array([ancestry.get(i[:12], 'OA') for i in data if (data[i][0] / (data[i][1] / 1e6)) < cutoff])
...
with open(cwd / 'tables' / 'table_1' / 'DUKE-F1-DX1' / 'tumor_only_strict' / 'results' / 'gmm_syn_predictions.pkl', 'wb') as f:
