...
##counting metrics
data = pickle.load(open(cwd / 'tables' / 'table_1' / 'MDA_409' / 'data' / 'data.pkl', 'rb'))
...
print('deeptmb')
run_predictions, test_idx, values = pickle.load(open(cwd / 'tables' / 'table_1' / 'MDA_409' / 'results' / 'run_nonsyn_predictions.pkl', 'rb'))
...
print('hotspots')
run_cancer_predictions, test_idx, values = pickle.load(open(cwd / 'tables' / 'table_1' / 'MDA_409' / 'results' / 'run_hotspots_predictions.pkl', 'rb'))
...
print('syn')
run_predictions, test_idx, values = pickle.load(open(cwd / 'tables' / 'table_1' / 'MDA_409' / 'results' / 'run_predictions.pkl', 'rb'))
...
print('hotspots syn')
run_cancer_predictions, test_idx, values = pickle.load(open(cwd / 'tables' / 'table_1' / 'MDA_409' / 'results' / 'run_hotspots_syn_predictions.pkl', 'rb'))
...
print('nci')
run_cancer_predictions, test_idx, values = pickle.load(open(cwd / 'tables' / 'table_1' / 'MDA_409' / 'results' / 'run_nci_predictions.pkl', 'rb'))
