...
run_predictions, test_idx, values, losses = pickle.load(open(cwd / 'tables' / 'table_2' / 'DUKE-F1-DX1' / 'tumor_only_strict' / 'results' / 'without_ancestry.pkl', 'rb'))
...
print('with ancestry')
run_predictions, test_idx, values, losses = pickle.load(open(cwd / 'tables' / 'table_2' / 'DUKE-F1-DX1' / 'tumor_only_strict' / 'results' / 'with_ancestry.pkl', 'rb'))
